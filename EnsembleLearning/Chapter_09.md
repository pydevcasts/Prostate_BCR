...
**یادداشت برای کتاب:** این نمودارها را همراه با توضیح خط‌به‌خط درج کن — خواننده باید بفهمد چگونه از ماتریس و ROC برای تصمیم‌گیری‌های عملی (مثلاً آستانهٔ تصمیم‌گیری threshold tuning) استفاده کند.
