...
## 📖 صفحه ۵: تحلیل داده‌ها (EDA) – بخش اول
...
📍 در صفحه بعد (صفحه ۶)، تحلیل داده‌ها را ادامه می‌دهیم و با استفاده از **Correlation Matrix** و نمودارهای جفتی (Pair Plots) روابط میان ویژگی‌ها را بررسی خواهیم کرد.
