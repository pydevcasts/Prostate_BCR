...
* Random Forest بهترین عملکرد کلی را دارد.
* Logistic Regression و SVM عملکرد بسیار نزدیک دارند.
...
* Random Forest و SVM هر دو Recall بالایی دارند، بنابراین انتخاب‌های مناسبی هستند.
* Logistic Regression ساده‌تر و سریع‌تر است و همچنان عملکرد عالی دارد.
